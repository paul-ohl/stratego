...
class Seed1702384855974 {
    async up(run) {
        ...
        await run.manager.save(run.manager.create(hint_entity_1.Hint, {
            positions: '[2,8,5,2,6,2,9,3,2,6,10,2,7,8,2,6,1,5,11,5,6,4,7,1,7,5,11,4,11,4,3,2,3,3,4,11,0,11,3,2]',
        }));
        await run.manager.save(run.manager.create(hint_entity_1.Hint, {
        ...
        await run.manager.save(run.manager.create(hint_entity_1.Hint, {
            positions: '[2,2,11,0,11,11,4,2,2,2,7,9,8,11,10,7,11,3,8,7,5,4,6,6,3,3,4,2,6,5,2,4,3,5,2,1,4,11,5,3]',
        }));
        await run.manager.save(run.manager.create(hint_entity_1.Hint, {
